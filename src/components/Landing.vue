...
<template>
  <main>
    <div
      class="bg-slate-200 text-black h-16 w-full flex justify-between items-center p-4 md:px-10"
    >
      <button
      ...
      <p class="font-medium" v-if="userInfo">
    ...
    <div class="h-[calc(100vh-64px)]">
      <div class="flex h-full relative">
        <div
          class="w-64 h-full absolute md:relative"
          :class="{ hidden: !isShowSidebar }"
        >
          <div class="bg-slate-100 border-r h-full">
            <div class="p-2">this is side bar</div>
          </div>
        </div>
        <div
        ...
        >
          <div class="rounded-lg py-4 mb-4">
            <div class="grid grid-cols-12 gap-4" v-if="btcPrice">
              ...
              <div class="col-span-12 md:col-span-6 lg:col-span-4">
                <div
                  class="p-4 bg-yellow-500 text-white text-3xl font-semibold rounded-lg"
                >
          ...
          <div>
            <div class="grid grid-cols-12 gap-4" v-if="imagesList">
              <div
                class="bg-blue-400 col-span-12 md:col-span-6 lg:col-span-4 rounded-lg"
